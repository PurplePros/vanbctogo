...
include 'db.php';
    ...
    $query = "SELECT Main.*, Contacts.*, Options.*, Locations.*, busyness.*
                FROM Main INNER JOIN Contacts ON (SUBSTRING(Main.restaurant_id, 1,3) = 'ric' AND Main.restaurant_id = Contacts.restaurant_id_4) 
...
<html lang="en">
	...
	<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="richmond.php">Richmond</a>
		...
		<main>
			<div class="listing">
				<h3>Local restaurants in <span class="highlightCity">RICHMOND</span></h3>
        ...
        <script>
                ...
                function initMap() {
                    ...
                    map = new google.maps.Map(document.getElementById("map"), {
                        center: { lat: 49.1665898, lng: -123.1335690 },
                        zoom: 14,
                ...
                return new Promise(function(resolve) {
                    ...
                    if (longitudes === null || longitudes[i] === null) {
                        if (!isNaN(addresses[i].charAt(0))) {
                            let link = addresses[i] + ", Richmond, BC"
