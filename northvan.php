<?php
    ...
    $query = "SELECT Main.*, Contacts.*, Options.*, Locations.*, busyness.*
                FROM Main INNER JOIN Contacts ON (SUBSTRING(Main.restaurant_id, 1,3) = 'nva' AND Main.restaurant_id = Contacts.restaurant_id_4) 
...
<html lang="en">
	<head>
		...
		<title>North Vancouver listing</title>
		<meta charset="utf-8">
	...
	<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="northvan.php">North Vancouver</a>
		...
		<main>
			<div class="listing">
				<h3>Local restaurants in <span class="highlightCity">NORTH VANCOUVER</span></h3>
                ...
                <div class="placesList">
    	            <div class= "filter">
        	            <div class="d-flex flex-wrap justify-content-center">
        	                ...
        	                <button class="filterButtons" id="east-asian">East Asian</button>
		...
		<script type="text/javascript">
            ...
            var chineseFilter = document.getElementById("east-asian");
            ...
            var japaneseFilter = document.getElementById("bar-pub");
            ...
            var comfortFilter = document.getElementById("canadian");
        ...
        <script>
                ...
                function initMap() {
                    ...
                    map = new google.maps.Map(document.getElementById("map"), {
                        center: { lat: 49.3200, lng: -123.0724 },
                        zoom: 14,
                ...
                return new Promise(function(resolve) {
                    ...
                    if (longitudes === null || longitudes[i] === null) {
                        if (!isNaN(addresses[i].charAt(0))) {
                            let link = addresses[i] + ", North Vancouver, BC"
