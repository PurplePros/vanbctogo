<?php
    ...
    $query = "SELECT Main.*, Contacts.*, Options.*, Locations.*, busyness.*
                FROM Main INNER JOIN Contacts ON (SUBSTRING(Main.restaurant_id, 1,3) = 'van' AND Main.restaurant_id = Contacts.restaurant_id_4) 
...
<html lang="en">
	...
	<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item active" href="vancouver.php">Vancouver</a>
		...
		<main>
			<div class="listing">
				<h3>Local restaurants in <span class="highlightCity">VANCOUVER</span></h3>
                ...
                return new Promise(function(resolve) {
                    ...
                    if (longitudes === null || longitudes[i] === null) {
                        if (!isNaN(addresses[i].charAt(0))) {
                            let link = addresses[i] + ", Vancouver, BC"
