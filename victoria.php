<?php
    ...
    $query = "SELECT Main.*, Contacts.*, Options.*, Locations.*, busyness.*
                FROM Main INNER JOIN Contacts ON (SUBSTRING(Main.restaurant_id, 1,3) = 'vic' AND Main.restaurant_id = Contacts.restaurant_id_4) 
...
<html lang="en">
	...
	<body>
		...
		<main>
			<div class="listing">
				<h3>Local restaurants in <span class="highlightCity">VICTORIA</span></h3>
                ...
                <div class="placesList">
    	            <div class= "filter">
        	            <div class="d-flex flex-wrap justify-content-center">
        	                ...
        	                <button class="filterButtons" id="dessert-bakery">Bakery/Dessert Shop</button>
        	                <button class="filterButtons" id="brewery">Brewery</button>
        	                <button class="filterButtons" id="bar-pub">Bar/Pub</button>
        	                ...
        	                <button class="filterButtons" id="southeast-asian">Southeast Asian</button>
        	                <button class="filterButtons" id="asian">Asian</button>
        	                <button class="filterButtons" id="latin">Latin American/Caribbean</button>
        	                <button class="filterButtons" id="italian">Italian</button>
        	                <button class="filterButtons" id="euro">European</button>
        	                <button class="filterButtons" id="med-mid">Mediterranean</button>
        	                <button class="filterButtons" id="seafood">Seafood</button>
        	                <button class="filterButtons" id="canadian">Canadian</button>
        	                <button class="filterButtons" id="comfort">Comfort Foods</button>
		...
		<script type="text/javascript">
            ...
            var canadianFilter = document.getElementById("canadian");
            canadianFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "canadian",
                   city: "vic"
                ...
                canadianFilter.style.backgroundColor = "#4f86fe";
                currentBtn = canadianFilter;
            });
            
            var dessertbakeryFilter = document.getElementById("dessert-bakery");
            dessertbakeryFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "dessert-bakery",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                dessertbakeryFilter.style.backgroundColor = "#4f86fe";
                currentBtn = dessertbakeryFilter;
            });
            
            var breweryFilter = document.getElementById("brewery");
            breweryFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "brewery",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                breweryFilter.style.backgroundColor = "#4f86fe";
                currentBtn = breweryFilter;
            });
            ...
            var southeastFilter = document.getElementById("southeast-asian");
            southeastFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
               ...
               if(currentBtn) {
                ...
                southeastFilter.style.backgroundColor = "#4f86fe";
                currentBtn = southeastFilter;
            });
            
            var latinFilter = document.getElementById("latin");
            latinFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "latin",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                latinFilter.style.backgroundColor = "#4f86fe";
                currentBtn = latinFilter;
            });
            ...
            var euroFilter = document.getElementById("euro");
            euroFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "euro",
                   city: "vic"
                ...
                euroFilter.style.backgroundColor = "#4f86fe";
                currentBtn = euroFilter;
            });
            ...
            var comfortFilter = document.getElementById("comfort");
            comfortFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "comfort",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                comfortFilter.style.backgroundColor = "#4f86fe";
                currentBtn = comfortFilter;
            });
            var asianFilter = document.getElementById("asian");
            asianFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "asian",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                asianFilter.style.backgroundColor = "#4f86fe";
                currentBtn = asianFilter;
            });
            
            var seafoodFilter = document.getElementById("seafood");
            seafoodFilter.addEventListener("click", function() {
               $(".restaurants").innerHTML = '';
               $(".restaurants").load("displaydata.php", {
                   type: "seafood",
                   city: "vic"
               ...
               if(currentBtn) {
                ...
                seafoodFilter.style.backgroundColor = "#4f86fe";
                currentBtn = seafoodFilter;
            });
	    </script>
        <script>
                var map;
                ...
                return new Promise(function(resolve) {
                    ...
                    if (longitudes === null || longitudes[i] === null) {
                        if (!isNaN(addresses[i].charAt(0))) {
                            let link = addresses[i] + ", Victoria, BC"
                            geocoder.geocode( {'address': link}, function(results, status) {
                                if (status == 'OK') {
                                    ...
                                    var call = function() {
                                        $.ajax({
                                            url:"https://www.vanbctogo.ca/new/mapdata.php",
                                            type:"POST",
