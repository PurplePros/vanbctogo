<?php
    ...
    $query = "SELECT Main.*, Contacts.*, Options.*, Locations.*, busyness.*
                FROM Main INNER JOIN Contacts ON (SUBSTRING(Main.restaurant_id, 1,3) = 'kel' AND Main.restaurant_id = Contacts.restaurant_id_4) 
...
<html lang="en">
	...
	<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="kelowna.php">Kelowna</a>
		...
		<main>
			<div class="listing">
				<h3>Local restaurants in <span class="highlightCity">KELOWNA</span></h3>
                ...
                return new Promise(function(resolve) {
                    ...
                    if (longitudes === null || longitudes[i] === null) {
                        if (!isNaN(addresses[i].charAt(0))) {
                            let link = addresses[i] + ", Kelowna, BC"
                            geocoder.geocode( {'address': link}, function(results, status) {
                                if (status == 'OK') {
                                    ...
                                    var call = function() {
                                        $.ajax({
                                            url:"https://www.vanbctogo.ca/mapdata.php",
                                            type:"POST",
